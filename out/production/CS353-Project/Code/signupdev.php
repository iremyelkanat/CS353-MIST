...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    echo "<script type='text/javascript'>alert('checkpoint 1');</script>";
    $companyName = trim($_POST["company-name"]);
    $email = trim($_POST["email"]);
    $password = trim($_POST["password"]);
    $phoneNumber = trim($_POST["phone-number"]);

    echo "<script type='text/javascript'>alert('checkpoint 2');</script>";
    ...
    echo "<script type='text/javascript'>alert('checkpoint 3');</script>";
    ...
    echo "<script type='text/javascript'>alert('checkpoint 4');</script>";
    ...
    echo "<script type='text/javascript'>alert('checkpoint 5');</script>";
    ...
    if ($num_of_rows_phone_check > 0) {
        ...
        $insert_dev_company_query = "INSERT INTO Developer_Company VALUES ('$a_ID');";
        $insert_dev_company_result = mysqli_query($db, $insert_dev_company_query);
