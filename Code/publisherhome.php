    ...
    <div class="main-div" style="display: flex; padding-left: 2%; padding-right: 2%; padding-top: 2%; padding-bottom: 1%">
        <div class="information-header" style="width: 100%">
            ...
            <div class="information-detail-p1"; style="font-size: 24px">
                <?php
                $account_query = "SELECT c_name, email_address FROM Accountt NATURAL JOIN Publisher_Company NATURAL JOIN Company WHERE a_ID =" . $_SESSION['a_ID'] . ";";
            ...
            <div class="information-detail-p2"; style="font-size: 24px">
                <?php
                $approved_query = "SELECT COUNT(*) AS num_of_games_approved FROM takes t WHERE t.state='Approved' AND t.a_ID =" . $_SESSION['a_ID'] . ";";
                $declined_query = "SELECT COUNT(*) AS num_of_games_declined FROM takes t WHERE t.state='Declined' AND t.a_ID =" . $_SESSION['a_ID'] . ";";
                $online_query = "SELECT COUNT(*) AS num_of_requests_online FROM takes t WHERE (t.state<>'Approved' AND t.state<>'Declined') AND t.a_ID =" . $_SESSION['a_ID'] . ";";
