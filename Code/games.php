                                        ...
                                        <div class="modal-body" style="background-color: transparent; padding: 20px">
                                            <div style="background-color: white; height: 300px; width: 600px; border-radius: 30px; border-color: rgba(112,112,112,1); border-style: solid; padding: 20px">
                                                ...
                                                <div style="align-items: center;">
                                                    <form id="request-game-form" method="post">
                                                        <label for="cars" style="width: 100%; font-size: 25px;">Choose a Publisher Company:</label>
                                                        <div style="border-style: solid; border-radius: 10px; border-color: slategrey; border-width: 1px; padding: 3px;">
                                                            <select name="cars" id="cars" style="width: 100%; font-size: 20px; outline: none;">
                                                        ...
                                                        <div class="form-group" style="margin-top: 5%; text-align: right">
                                                            <input onclick="checkEmptyAndLogin()" type="button" class="btn btn-primary" style="background-color: rgb(86, 188, 22); border-color: rgb(86, 188, 22); border-radius: 20px" value="  Send  ">
                                                        </div>
                                                        <br><br>
                                                    </form>
                                                </div>
                                                    ...
                                                    <form id="create-game-form" method="post">
                                                        <div style="display: flex; font-size: 20px;">
                                                            ...
                                                            <div class="input-group" style=" margin-bottom: 2%; margin-top: 4%; font-size: 20px; font-size: 20px;" >
                                                                <input id="game-version" type="text" class="form-control" name="game-name" placeholder="Game Version" style=" outline: none; font-size: 20px; border-style: solid; border-radius: 20px">
                                                            </div>
                                                        </div>
                                                        <div class="input-group" style="margin-top: 10px; margin-bottom: 20px; border-style: solid; border-radius: 20px; border-color: slategrey; border-width: 1px; padding: 5px;">
                                                            <select name="genres" id="cars" style="width: 100%; font-size: 20px; outline: none;" >
                                                        ...
                                                        <div class="input-group" style=" margin-bottom: 10px; margin-top: 20px">
                                                            <textarea id="game-description" rows="4" maxlength="280" class="form-control" name="game-description" placeholder="Game Description" style=" outline: none; resize: none; display: block; font-size: 20px; border-style: solid; border-radius: 20px"></textarea>
                                                        </div>
                                                        <div class="input-group" style=" margin-bottom: 10px; margin-top: 20px">
                                                        ...
                                                        <div class="form-group" style="margin-top: 5%; text-align: right">
                                                            <input onclick="checkEmptyAndCreate()" type="button" class="btn btn-primary" style="background-color: rgb(86, 188, 22); border-color: rgb(86, 188, 22); border-radius: 20px" value="  Create  ">
                                                        </div>
                                                        <br><br>
                                                    </form>
                                                </div>
